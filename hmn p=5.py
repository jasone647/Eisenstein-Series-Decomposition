...
hmder6  = q*derivative(hmder5,q) - ((weight+10)/12) * E2 *hmder5
...
M=Matrix([[xx[ii] for xx in [hm*E4^3,hm*E4s*E4^2,hm*E4s^2*E4,hm*E4s^3,hm*E4^2*E2s^2,hm*E4s*E4*E2s^2,hm*E4s^2*E2s^2,
                             hm*E4*E2s^4,hm*E4s*E2s^4,hm*E2s^5,
                            hmder*E2s^5,hmder*E2s*E4^2,hmder*E2s*E4s^2,hmder*E2s^3*E4,
                            hmder*E2s^3*E4s, hmder2*E2s^4,hmder2*E2s^2*E4,hmder2*E2s*E6,
                            hmder2*E4^2,hmder3*E2s^3,hmder3*E4*E2s,hmder3*E6,hmder4*E4,
                            hmder5*E2s,hmder6]] for ii in range(30)])
show(M.rref())
